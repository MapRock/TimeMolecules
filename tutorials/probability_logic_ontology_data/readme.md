...
Knowledge Graphs, Semantic Layers, Prolog, all involve a lot of engineering, a lot of human-in-the-loop, which is frowned upon at the time of writing. But my books and [blogs](https://eugeneasahara.com/) describe automation of these structures, which is only feasible with the advent of easy-to-access and relatively inexpensive LLMs (and other non-LLM ML models). I know all too well that LLMs fall short in working with me as a peer partner (at this time), but it is rather good at performing mundane tasks that are substantially time-consuming. This art of working with LLMs, combining human and machine intelligence, is just getting started.
