...
I'm not claiming that I'm the first to have thought of this, nor do I claim this is the home run to drive-in the winning run. Rather, these are challenges that existed back in the 2000s where I faced such issues at the client sites. And they are still a challenge. I propose Time Molecules as the #2 or #3 hitter in the line up, akin to Derek Jetter getting on base for Alex Rodriguez to drive them all home.
